...
entryRuleDefinitionModelRule returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDefinitionModelRuleRule()); }
	iv_ruleDefinitionModelRule=ruleDefinitionModelRule
	{ $current=$iv_ruleDefinitionModelRule.current; }
	EOF;

// Rule DefinitionModelRule
ruleDefinitionModelRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleClassDefinitionRule returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getClassDefinitionRuleRule()); }
	iv_ruleClassDefinitionRule=ruleClassDefinitionRule
	{ $current=$iv_ruleClassDefinitionRule.current; }
	EOF;

// Rule ClassDefinitionRule
ruleClassDefinitionRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleFunctionDefinitionRule returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getFunctionDefinitionRuleRule()); }
	iv_ruleFunctionDefinitionRule=ruleFunctionDefinitionRule
	{ $current=$iv_ruleFunctionDefinitionRule.current; }
	EOF;

// Rule FunctionDefinitionRule
ruleFunctionDefinitionRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
