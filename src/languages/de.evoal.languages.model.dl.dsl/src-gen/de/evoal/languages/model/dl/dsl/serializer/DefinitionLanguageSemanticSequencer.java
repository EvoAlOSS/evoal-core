...
public class DefinitionLanguageSemanticSequencer extends BaseLanguageSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == BasePackage.eINSTANCE)
			...
			case DdlPackage.DATA_TYPE:
				sequence_DefinedDataTypeRule(context, (de.evoal.languages.model.ddl.DataType) semanticObject); 
				return; 
	 ...
	 *     DefinedDataTypeRule returns DataType
	 *
	 * Constraint:
	 *     definition=[DataDescription|QualifiedName]
	 * </pre>
	 */
	protected void sequence_DefinedDataTypeRule(ISerializationContext context, de.evoal.languages.model.ddl.DataType semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, DdlPackage.Literals.DATA_TYPE__DEFINITION) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, DdlPackage.Literals.DATA_TYPE__DEFINITION));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getDefinedDataTypeRuleAccess().getDefinitionDataDescriptionQualifiedNameParserRuleCall_0_1(), semanticObject.eGet(DdlPackage.Literals.DATA_TYPE__DEFINITION, false));
		feeder.finish();
	}
