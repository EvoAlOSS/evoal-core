 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.el.impl.ComparisonExpressionImpl#getLeftOperand <em>Left Operand</em>}</li>
 *   <li>{@link de.evoal.languages.model.el.impl.ComparisonExpressionImpl#getComparison <em>Comparison</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComparisonExpressionImpl extends MinimalEObjectImpl.Container implements ComparisonExpression {
	...
	protected EClass eStaticClass() {
		return ELPackage.Literals.COMPARISON_EXPRESSION;
	}
	...
	public NotificationChain basicSetLeftOperand(AddOrSubtractExpression newLeftOperand, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ELPackage.COMPARISON_EXPRESSION__LEFT_OPERAND, oldLeftOperand, newLeftOperand);
	...
	public void setLeftOperand(AddOrSubtractExpression newLeftOperand) {
		if (newLeftOperand != leftOperand) {
			...
			if (leftOperand != null)
				msgs = ((InternalEObject)leftOperand).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ELPackage.COMPARISON_EXPRESSION__LEFT_OPERAND, null, msgs);
			if (newLeftOperand != null)
				msgs = ((InternalEObject)newLeftOperand).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ELPackage.COMPARISON_EXPRESSION__LEFT_OPERAND, null, msgs);
			msgs = basicSetLeftOperand(newLeftOperand, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ELPackage.COMPARISON_EXPRESSION__LEFT_OPERAND, newLeftOperand, newLeftOperand));
	}
	...
	public EList<PartialComparisonExpression> getComparison() {
		if (comparison == null) {
			comparison = new EObjectContainmentEList<PartialComparisonExpression>(PartialComparisonExpression.class, this, ELPackage.COMPARISON_EXPRESSION__COMPARISON);
		}
		return comparison;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ELPackage.COMPARISON_EXPRESSION__LEFT_OPERAND:
				return basicSetLeftOperand(null, msgs);
			case ELPackage.COMPARISON_EXPRESSION__COMPARISON:
