 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.el.impl.NumberLiteralImpl#getFactor <em>Factor</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NumberLiteralImpl extends LiteralImpl implements NumberLiteral {
	 ...
	 * @ordered
	 */
	protected static final Factor FACTOR_EDEFAULT = Factor.NONE;
	 ...
	 * @ordered
	 */
	protected Factor factor = FACTOR_EDEFAULT;
	...
	public void setFactor(Factor newFactor) {
		...
		factor = newFactor == null ? FACTOR_EDEFAULT : newFactor;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ELPackage.NUMBER_LITERAL__FACTOR, oldFactor, factor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ELPackage.NUMBER_LITERAL__FACTOR:
				return getFactor();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ELPackage.NUMBER_LITERAL___GET_VALUE:
				return getValue();
		}
