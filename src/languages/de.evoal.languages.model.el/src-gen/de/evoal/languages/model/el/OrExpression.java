 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.el.OrExpression#getSubExpressions <em>Sub Expressions</em>}</li>
 * </ul>
 *
 * @see de.evoal.languages.model.el.ELPackage#getOrExpression()
 * @model
 * @generated
 */
public interface OrExpression extends Expression {
	 ...
	 * The list contents are of type {@link de.evoal.languages.model.el.XorExpression}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Sub Expressions</em>' containment reference list.
	 * @see de.evoal.languages.model.el.ELPackage#getOrExpression_SubExpressions()
