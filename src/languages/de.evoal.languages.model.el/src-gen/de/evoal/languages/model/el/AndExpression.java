 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.el.AndExpression#getSubExpressions <em>Sub Expressions</em>}</li>
 * </ul>
 *
 * @see de.evoal.languages.model.el.ELPackage#getAndExpression()
 * @model
 * @generated
 */
public interface AndExpression extends EObject {
	 ...
	 * The list contents are of type {@link de.evoal.languages.model.el.NotExpression}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the value of the '<em>Sub Expressions</em>' containment reference list.
	 * @see de.evoal.languages.model.el.ELPackage#getAndExpression_SubExpressions()
