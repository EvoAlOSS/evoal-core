 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.el.impl.PartialComparisonExpressionImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link de.evoal.languages.model.el.impl.PartialComparisonExpressionImpl#getSubExpression <em>Sub Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PartialComparisonExpressionImpl extends MinimalEObjectImpl.Container implements PartialComparisonExpression {
	...
	protected EClass eStaticClass() {
		return ELPackage.Literals.PARTIAL_COMPARISON_EXPRESSION;
	}
	...
	public void setOperator(ComparisonOperator newOperator) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ELPackage.PARTIAL_COMPARISON_EXPRESSION__OPERATOR, oldOperator, operator));
	}
	...
	public NotificationChain basicSetSubExpression(AddOrSubtractExpression newSubExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ELPackage.PARTIAL_COMPARISON_EXPRESSION__SUB_EXPRESSION, oldSubExpression, newSubExpression);
	...
	public void setSubExpression(AddOrSubtractExpression newSubExpression) {
		if (newSubExpression != subExpression) {
			...
			if (subExpression != null)
				msgs = ((InternalEObject)subExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ELPackage.PARTIAL_COMPARISON_EXPRESSION__SUB_EXPRESSION, null, msgs);
			if (newSubExpression != null)
				msgs = ((InternalEObject)newSubExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ELPackage.PARTIAL_COMPARISON_EXPRESSION__SUB_EXPRESSION, null, msgs);
			msgs = basicSetSubExpression(newSubExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ELPackage.PARTIAL_COMPARISON_EXPRESSION__SUB_EXPRESSION, newSubExpression, newSubExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ELPackage.PARTIAL_COMPARISON_EXPRESSION__SUB_EXPRESSION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ELPackage.PARTIAL_COMPARISON_EXPRESSION__OPERATOR:
				return getOperator();
			case ELPackage.PARTIAL_COMPARISON_EXPRESSION__SUB_EXPRESSION:
