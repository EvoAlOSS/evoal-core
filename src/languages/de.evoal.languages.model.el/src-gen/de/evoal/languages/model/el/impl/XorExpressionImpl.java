 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.el.impl.XorExpressionImpl#getSubExpressions <em>Sub Expressions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class XorExpressionImpl extends MinimalEObjectImpl.Container implements XorExpression {
	...
	protected EClass eStaticClass() {
		return ELPackage.Literals.XOR_EXPRESSION;
	}
	...
	public EList<AndExpression> getSubExpressions() {
		if (subExpressions == null) {
			subExpressions = new EObjectContainmentEList<AndExpression>(AndExpression.class, this, ELPackage.XOR_EXPRESSION__SUB_EXPRESSIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ELPackage.XOR_EXPRESSION__SUB_EXPRESSIONS:
