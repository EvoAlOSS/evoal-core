...
public abstract class AttributeDefinitionImpl extends MinimalEObjectImpl.Container implements AttributeDefinition {
	...
	protected EClass eStaticClass() {
		return DlPackage.Literals.ATTRIBUTE_DEFINITION;
	}
	...
	public NotificationChain basicSetType(Type newType, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, DlPackage.ATTRIBUTE_DEFINITION__TYPE, oldType, newType);
	...
	public void setType(Type newType) {
		if (newType != type) {
			...
			if (type != null)
				msgs = ((InternalEObject)type).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - DlPackage.ATTRIBUTE_DEFINITION__TYPE, null, msgs);
			if (newType != null)
				msgs = ((InternalEObject)newType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - DlPackage.ATTRIBUTE_DEFINITION__TYPE, null, msgs);
			msgs = basicSetType(newType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DlPackage.ATTRIBUTE_DEFINITION__TYPE, newType, newType));
	}
