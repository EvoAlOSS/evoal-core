 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.dl.impl.InstanceTypeImpl#getDefinitions <em>Definitions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstanceTypeImpl extends TypeImpl implements InstanceType {
	...
	protected EClass eStaticClass() {
		return DlPackage.Literals.INSTANCE_TYPE;
	}
	...
	public EList<TypeDefinition> getDefinitions() {
		if (definitions == null) {
			definitions = new EObjectResolvingEList<TypeDefinition>(TypeDefinition.class, this, DlPackage.INSTANCE_TYPE__DEFINITIONS);
		}
		return definitions;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DlPackage.INSTANCE_TYPE__DEFINITIONS:
