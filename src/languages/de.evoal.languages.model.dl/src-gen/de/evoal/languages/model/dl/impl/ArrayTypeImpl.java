 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.dl.impl.ArrayTypeImpl#getElements <em>Elements</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayTypeImpl extends TypeImpl implements ArrayType {
	...
	protected EClass eStaticClass() {
		return DlPackage.Literals.ARRAY_TYPE;
	}
	...
	public EList<Type> getElements() {
		if (elements == null) {
			elements = new EObjectContainmentEList<Type>(Type.class, this, DlPackage.ARRAY_TYPE__ELEMENTS);
		}
		return elements;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DlPackage.ARRAY_TYPE__ELEMENTS:
