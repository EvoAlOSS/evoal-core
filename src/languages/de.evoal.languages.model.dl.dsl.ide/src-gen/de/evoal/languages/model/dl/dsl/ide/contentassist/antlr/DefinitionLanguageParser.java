...
public class DefinitionLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DefinitionLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDefinitionModelRuleAccess().getEnumsAssignment_4_0(), "rule__DefinitionModelRule__EnumsAssignment_4_0");
			builder.put(grammarAccess.getDefinitionModelRuleAccess().getTypesAssignment_4_1(), "rule__DefinitionModelRule__TypesAssignment_4_1");
			builder.put(grammarAccess.getDefinitionModelRuleAccess().getFunctionsAssignment_4_2(), "rule__DefinitionModelRule__FunctionsAssignment_4_2");
			builder.put(grammarAccess.getDefinitionModelRuleAccess().getConstantsAssignment_4_3(), "rule__DefinitionModelRule__ConstantsAssignment_4_3");
