 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.ddl.impl.UntypedBaseDataDescriptionImpl#getScale <em>Scale</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UntypedBaseDataDescriptionImpl extends BaseDataDescriptionImpl implements UntypedBaseDataDescription {
	...
	protected EClass eStaticClass() {
		return DdlPackage.Literals.UNTYPED_BASE_DATA_DESCRIPTION;
	}
	...
	public void setScale(ScaleType newScale) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DdlPackage.UNTYPED_BASE_DATA_DESCRIPTION__SCALE, oldScale, scale));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DdlPackage.UNTYPED_BASE_DATA_DESCRIPTION__SCALE:
				return getScale();
		}
