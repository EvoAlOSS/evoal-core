 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.ddl.impl.DataReferenceImpl#getDefinition <em>Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataReferenceImpl extends ValueReferenceImpl implements DataReference {
	...
	protected EClass eStaticClass() {
		return DdlPackage.Literals.DATA_REFERENCE;
	}
		...
		if (definition != null && definition.eIsProxy()) {
			...
			if (definition != oldDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DdlPackage.DATA_REFERENCE__DEFINITION, oldDefinition, definition));
			}
		}
		return definition;
	}
	...
	public void setDefinition(DataDescription newDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DdlPackage.DATA_REFERENCE__DEFINITION, oldDefinition, definition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DdlPackage.DATA_REFERENCE__DEFINITION:
