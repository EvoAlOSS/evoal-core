...
:
	(
		{ before(grammarAccess.getTypedBaseDataDescriptionRuleAccess().getTypeDataTypeTypeDefinitionCrossReference_5_0_1_0()); }
		(
			{ before(grammarAccess.getTypedBaseDataDescriptionRuleAccess().getTypeDataTypeTypeDefinitionQualifiedNameParserRuleCall_5_0_1_0_1()); }
			ruleQualifiedName
			{ after(grammarAccess.getTypedBaseDataDescriptionRuleAccess().getTypeDataTypeTypeDefinitionQualifiedNameParserRuleCall_5_0_1_0_1()); }
		)
		{ after(grammarAccess.getTypedBaseDataDescriptionRuleAccess().getTypeDataTypeTypeDefinitionCrossReference_5_0_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getTypedBaseDataDescriptionRuleAccess().getTypeEnumDefinitionCrossReference_5_1_1_0()); }
		(
			{ before(grammarAccess.getTypedBaseDataDescriptionRuleAccess().getTypeEnumDefinitionQualifiedNameParserRuleCall_5_1_1_0_1()); }
			ruleQualifiedName
			{ after(grammarAccess.getTypedBaseDataDescriptionRuleAccess().getTypeEnumDefinitionQualifiedNameParserRuleCall_5_1_1_0_1()); }
		)
		{ after(grammarAccess.getTypedBaseDataDescriptionRuleAccess().getTypeEnumDefinitionCrossReference_5_1_1_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
...
:
	(
		{ before(grammarAccess.getStructuredDataDescriptionRuleAccess().getTypeClassDefinitionCrossReference_5_0()); }
		(
			{ before(grammarAccess.getStructuredDataDescriptionRuleAccess().getTypeClassDefinitionQualifiedNameParserRuleCall_5_0_1()); }
			ruleQualifiedName
			{ after(grammarAccess.getStructuredDataDescriptionRuleAccess().getTypeClassDefinitionQualifiedNameParserRuleCall_5_0_1()); }
		)
		{ after(grammarAccess.getStructuredDataDescriptionRuleAccess().getTypeClassDefinitionCrossReference_5_0()); }
	)
;
finally {
	restoreStackSize(stackSize);
