...
public class DataDescriptionLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DataDescriptionLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getUntypedBaseDataDescriptionRuleAccess().getGroup_4(), "rule__UntypedBaseDataDescriptionRule__Group_4__0");
			...
			builder.put(grammarAccess.getTypedBaseDataDescriptionRuleAccess().getTypeAssignment_5(), "rule__TypedBaseDataDescriptionRule__TypeAssignment_5");
			...
			builder.put(grammarAccess.getUntypedBaseDataDescriptionRuleAccess().getScaleAssignment_0(), "rule__UntypedBaseDataDescriptionRule__ScaleAssignment_0");
			builder.put(grammarAccess.getUntypedBaseDataDescriptionRuleAccess().getRepresentationAssignment_1(), "rule__UntypedBaseDataDescriptionRule__RepresentationAssignment_1");
			builder.put(grammarAccess.getUntypedBaseDataDescriptionRuleAccess().getNameAssignment_3(), "rule__UntypedBaseDataDescriptionRule__NameAssignment_3");
			builder.put(grammarAccess.getUntypedBaseDataDescriptionRuleAccess().getConstraintsAssignment_4_3(), "rule__UntypedBaseDataDescriptionRule__ConstraintsAssignment_4_3");
