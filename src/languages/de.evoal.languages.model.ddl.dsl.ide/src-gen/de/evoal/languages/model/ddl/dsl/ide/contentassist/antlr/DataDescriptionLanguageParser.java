...
public class DataDescriptionLanguageParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DataDescriptionLanguageGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDataTypeDefinitionRuleAccess().getGroup_5(), "rule__DataTypeDefinitionRule__Group_5__0");
			...
			builder.put(grammarAccess.getDataTypeDefinitionRuleAccess().getConstraints2Assignment_0(), "rule__DataTypeDefinitionRule__Constraints2Assignment_0");
			builder.put(grammarAccess.getDataTypeDefinitionRuleAccess().getScaleAssignment_1(), "rule__DataTypeDefinitionRule__ScaleAssignment_1");
			builder.put(grammarAccess.getDataTypeDefinitionRuleAccess().getNameAssignment_3(), "rule__DataTypeDefinitionRule__NameAssignment_3");
			builder.put(grammarAccess.getDataTypeDefinitionRuleAccess().getDescriptionAssignment_4_2(), "rule__DataTypeDefinitionRule__DescriptionAssignment_4_2");
			builder.put(grammarAccess.getDataTypeDefinitionRuleAccess().getConstraintsAssignment_5_3(), "rule__DataTypeDefinitionRule__ConstraintsAssignment_5_3");
