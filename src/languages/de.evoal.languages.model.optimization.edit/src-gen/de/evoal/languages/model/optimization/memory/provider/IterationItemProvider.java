...
/**
 * This is the item provider adapter for a {@link de.evoal.languages.model.optimization.memory.Iteration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IterationItemProvider extends StateItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Iteration_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Iteration_number_feature", "_UI_Iteration_type"),
				 MemoryPackage.Literals.ITERATION__NUMBER,
				 false,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MemoryPackage.Literals.ITERATION__INDIVIDUALS);
		}
	...
	public String getText(Object object) {
		BigInteger labelValue = ((Iteration)object).getNumber();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Iteration.class)) {
			case MemoryPackage.ITERATION__NUMBER:
				...
				return;
			case MemoryPackage.ITERATION__INDIVIDUALS:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MemoryPackage.Literals.ITERATION__INDIVIDUALS,
				 MemoryFactory.eINSTANCE.createIndividual()));
	}
