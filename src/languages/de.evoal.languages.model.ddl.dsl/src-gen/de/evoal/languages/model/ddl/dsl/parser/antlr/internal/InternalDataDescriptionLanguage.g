...
@after {
	...
	(
		...
		{
			$current = $this_InstanceTypeRule_5.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_VoidTypeRule_6.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_ExpressionTypeRule_7.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_LiteralTypeRule_8.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
