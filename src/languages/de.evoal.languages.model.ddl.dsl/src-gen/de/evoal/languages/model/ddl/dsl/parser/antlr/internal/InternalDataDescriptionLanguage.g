...
entryRuleDataTypeDefinitionRule returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getDataTypeDefinitionRuleRule()); }
	iv_ruleDataTypeDefinitionRule=ruleDataTypeDefinitionRule
	{ $current=$iv_ruleDataTypeDefinitionRule.current; }
	EOF;

// Rule DataTypeDefinitionRule
ruleDataTypeDefinitionRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
	...
	(
		...
		{
			$current = $this_BaseDataTypeTypeDefinitionRule_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_EnumTypeDefinitionRule_1.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleBaseDataTypeTypeDefinitionRule returns [EObject current=null]:
	...
	{ $current=$iv_ruleBaseDataTypeTypeDefinitionRule.current; }
	EOF;

// Rule BaseDataTypeTypeDefinitionRule
ruleBaseDataTypeTypeDefinitionRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleEnumLiteralRule returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEnumLiteralRuleRule()); }
	iv_ruleEnumLiteralRule=ruleEnumLiteralRule
	{ $current=$iv_ruleEnumLiteralRule.current; }
	EOF;

// Rule EnumLiteralRule
ruleEnumLiteralRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleEnumTypeDefinitionRule returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getEnumTypeDefinitionRuleRule()); }
	iv_ruleEnumTypeDefinitionRule=ruleEnumTypeDefinitionRule
	{ $current=$iv_ruleEnumTypeDefinitionRule.current; }
	EOF;

// Rule EnumTypeDefinitionRule
ruleEnumTypeDefinitionRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
@after {
	...
	(
		...
		{
			$current = $this_TypedBaseDataDescriptionRule_0.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_UntypedBaseDataDescriptionRule_1.current;
			afterParserOrEnumRuleCall();
		}
		    |
		{
		...
		{
			$current = $this_StructuredDataDescriptionRule_2.current;
			afterParserOrEnumRuleCall();
		}
	)
;
...
entryRuleTypedBaseDataDescriptionRule returns [EObject current=null]:
	...
	{ $current=$iv_ruleTypedBaseDataDescriptionRule.current; }
	EOF;

// Rule TypedBaseDataDescriptionRule
ruleTypedBaseDataDescriptionRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleUntypedBaseDataDescriptionRule returns [EObject current=null]:
	...
	{ $current=$iv_ruleUntypedBaseDataDescriptionRule.current; }
	EOF;

// Rule UntypedBaseDataDescriptionRule
ruleUntypedBaseDataDescriptionRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
...
entryRuleStructuredDataDescriptionRule returns [EObject current=null]:
	...
	{ $current=$iv_ruleStructuredDataDescriptionRule.current; }
	EOF;

// Rule StructuredDataDescriptionRule
ruleStructuredDataDescriptionRule returns [EObject current=null]
@init {
	enterRule();
}
@after {
