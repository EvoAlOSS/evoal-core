 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.instance.impl.DataReferenceImpl#getDefinition <em>Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataReferenceImpl extends ValueReferenceImpl implements DataReference {
	...
	protected EClass eStaticClass() {
		return InstancePackage.Literals.DATA_REFERENCE;
	}
		...
		if (definition != null && definition.eIsProxy()) {
			...
			if (definition != oldDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, InstancePackage.DATA_REFERENCE__DEFINITION, oldDefinition, definition));
			}
		}
		return definition;
	}
	...
	public void setDefinition(DataDescription newDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, InstancePackage.DATA_REFERENCE__DEFINITION, oldDefinition, definition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case InstancePackage.DATA_REFERENCE__DEFINITION:
