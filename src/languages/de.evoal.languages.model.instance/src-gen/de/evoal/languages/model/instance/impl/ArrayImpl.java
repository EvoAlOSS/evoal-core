 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.instance.impl.ArrayImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayImpl extends ValueImpl implements Array {
	...
	protected EClass eStaticClass() {
		return InstancePackage.Literals.ARRAY;
	}
	...
	public EList<Value> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<Value>(Value.class, this, InstancePackage.ARRAY__VALUES);
		}
		return values;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case InstancePackage.ARRAY__VALUES:
