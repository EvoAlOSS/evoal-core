...
public class InstanceFactoryImpl extends EFactoryImpl implements InstanceFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case InstancePackage.INSTANCE_MODULE: return createInstanceModule();
			default:
	 ...
	 */
	@Override
	public InstanceModule createInstanceModule() {
		InstanceModuleImpl instanceModule = new InstanceModuleImpl();
