 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.impl.UnaryAddOrSubtractExpressionImpl#getOperators <em>Operators</em>}</li>
 *   <li>{@link de.evoal.languages.model.base.impl.UnaryAddOrSubtractExpressionImpl#getSubExpression <em>Sub Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnaryAddOrSubtractExpressionImpl extends MinimalEObjectImpl.Container implements UnaryAddOrSubtractExpression {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.UNARY_ADD_OR_SUBTRACT_EXPRESSION;
	}
	...
	public EList<AddOrSubtractOperator> getOperators() {
		if (operators == null) {
			operators = new EDataTypeUniqueEList<AddOrSubtractOperator>(AddOrSubtractOperator.class, this, BasePackage.UNARY_ADD_OR_SUBTRACT_EXPRESSION__OPERATORS);
		}
		return operators;
	}
	...
	public void setSubExpression(Value newSubExpression) {
		if (newSubExpression != subExpression) {
			...
			if (subExpression != null)
				msgs = ((InternalEObject)subExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasePackage.UNARY_ADD_OR_SUBTRACT_EXPRESSION__SUB_EXPRESSION, null, msgs);
			if (newSubExpression != null)
				msgs = ((InternalEObject)newSubExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasePackage.UNARY_ADD_OR_SUBTRACT_EXPRESSION__SUB_EXPRESSION, null, msgs);
			msgs = basicSetSubExpression(newSubExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.UNARY_ADD_OR_SUBTRACT_EXPRESSION__SUB_EXPRESSION, newSubExpression, newSubExpression));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasePackage.UNARY_ADD_OR_SUBTRACT_EXPRESSION__OPERATORS:
				return getOperators();
			case BasePackage.UNARY_ADD_OR_SUBTRACT_EXPRESSION__SUB_EXPRESSION:
