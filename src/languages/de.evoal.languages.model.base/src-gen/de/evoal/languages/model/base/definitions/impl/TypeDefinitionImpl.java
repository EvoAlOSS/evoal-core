 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.definitions.impl.TypeDefinitionImpl#getAttributes <em>Attributes</em>}</li>
 *   <li>{@link de.evoal.languages.model.base.definitions.impl.TypeDefinitionImpl#getSuperType <em>Super Type</em>}</li>
 *   <li>{@link de.evoal.languages.model.base.definitions.impl.TypeDefinitionImpl#isAbstract <em>Abstract</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TypeDefinitionImpl extends DefinitionImpl implements TypeDefinition {
	...
	protected EClass eStaticClass() {
		return DefinitionsPackage.Literals.TYPE_DEFINITION;
	}
	...
	public EList<AttributeDefinition> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<AttributeDefinition>(AttributeDefinition.class, this, DefinitionsPackage.TYPE_DEFINITION__ATTRIBUTES);
		}
		return attributes;
	}
		...
		if (superType != null && superType.eIsProxy()) {
			...
			if (superType != oldSuperType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DefinitionsPackage.TYPE_DEFINITION__SUPER_TYPE, oldSuperType, superType));
			}
		}
		return superType;
	}
	...
	public void setSuperType(TypeDefinition newSuperType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.TYPE_DEFINITION__SUPER_TYPE, oldSuperType, superType));
	}
	...
	public void setAbstract(boolean newAbstract) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.TYPE_DEFINITION__ABSTRACT, oldAbstract, abstract_));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case DefinitionsPackage.TYPE_DEFINITION__ATTRIBUTES:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case DefinitionsPackage.TYPE_DEFINITION__SUPER_TYPE:
				if (resolve) return getSuperType();
				return basicGetSuperType();
			case DefinitionsPackage.TYPE_DEFINITION__ABSTRACT:
				return isAbstract();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DefinitionsPackage.TYPE_DEFINITION___FIND_ATTRIBUTE__STRING:
