 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.expressions.impl.NumberLiteralImpl#getFactor <em>Factor</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class NumberLiteralImpl extends LiteralImpl implements NumberLiteral {
	...
	public void setFactor(Factor newFactor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.NUMBER_LITERAL__FACTOR, oldFactor, factor));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpressionsPackage.NUMBER_LITERAL__FACTOR:
				return getFactor();
		}
