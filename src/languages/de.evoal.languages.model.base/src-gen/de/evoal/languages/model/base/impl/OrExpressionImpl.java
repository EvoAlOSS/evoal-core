 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.impl.OrExpressionImpl#getSubExpressions <em>Sub Expressions</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrExpressionImpl extends ExpressionImpl implements OrExpression {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.OR_EXPRESSION;
	}
	...
	public EList<XorExpression> getSubExpressions() {
		if (subExpressions == null) {
			subExpressions = new EObjectContainmentEList<XorExpression>(XorExpression.class, this, BasePackage.OR_EXPRESSION__SUB_EXPRESSIONS);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasePackage.OR_EXPRESSION__SUB_EXPRESSIONS:
