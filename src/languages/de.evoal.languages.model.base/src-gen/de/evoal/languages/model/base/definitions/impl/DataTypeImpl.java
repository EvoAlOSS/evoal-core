 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.definitions.impl.DataTypeImpl#getDefinition <em>Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataTypeImpl extends MinimalEObjectImpl.Container implements DataType {
	...
	protected EClass eStaticClass() {
		return DefinitionsPackage.Literals.DATA_TYPE;
	}
		...
		if (definition != null && definition.eIsProxy()) {
			...
			if (definition != oldDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DefinitionsPackage.DATA_TYPE__DEFINITION, oldDefinition, definition));
			}
		}
		return definition;
	}
	...
	public void setDefinition(DataDescription newDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.DATA_TYPE__DEFINITION, oldDefinition, definition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DefinitionsPackage.DATA_TYPE__DEFINITION:
