 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.impl.InstanceImpl#getDefinition <em>Definition</em>}</li>
 *   <li>{@link de.evoal.languages.model.base.impl.InstanceImpl#getAttributes <em>Attributes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class InstanceImpl extends LiteralImpl implements Instance {
	/**
		...
		if (definition != null && definition.eIsProxy()) {
			...
			if (definition != oldDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, BasePackage.INSTANCE__DEFINITION, oldDefinition, definition));
			}
		}
		return definition;
	}
	...
	public void setDefinition(TypeDefinition newDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.INSTANCE__DEFINITION, oldDefinition, definition));
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, BasePackage.INSTANCE__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case BasePackage.INSTANCE__DEFINITION:
