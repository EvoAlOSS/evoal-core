 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.definitions.impl.BaseDataDescriptionImpl#getRepresentation <em>Representation</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class BaseDataDescriptionImpl extends DataDescriptionImpl implements BaseDataDescription {
	...
	protected EClass eStaticClass() {
		return DefinitionsPackage.Literals.BASE_DATA_DESCRIPTION;
	}
	...
	public void setRepresentation(RepresentationType newRepresentation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.BASE_DATA_DESCRIPTION__REPRESENTATION, oldRepresentation, representation));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DefinitionsPackage.BASE_DATA_DESCRIPTION__REPRESENTATION:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case DefinitionsPackage.BASE_DATA_DESCRIPTION___GET_SCALE:
				return getScale();
		}
