 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.impl.ArrayImpl#getValues <em>Values</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ArrayImpl extends ValueImpl implements Array {
	...
	public EList<Value> getValues() {
		if (values == null) {
			values = new EObjectContainmentEList<Value>(Value.class, this, BasePackage.ARRAY__VALUES);
		}
		return values;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasePackage.ARRAY__VALUES:
