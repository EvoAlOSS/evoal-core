 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.impl.ParanthesesImpl#getSubExpression <em>Sub Expression</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParanthesesImpl extends ValueImpl implements Parantheses {
	...
	protected EClass eStaticClass() {
		return BasePackage.Literals.PARANTHESES;
	}
	...
	public NotificationChain basicSetSubExpression(Expression newSubExpression, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, BasePackage.PARANTHESES__SUB_EXPRESSION, oldSubExpression, newSubExpression);
	...
	public void setSubExpression(Expression newSubExpression) {
		if (newSubExpression != subExpression) {
			...
			if (subExpression != null)
				msgs = ((InternalEObject)subExpression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - BasePackage.PARANTHESES__SUB_EXPRESSION, null, msgs);
			if (newSubExpression != null)
				msgs = ((InternalEObject)newSubExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - BasePackage.PARANTHESES__SUB_EXPRESSION, null, msgs);
			msgs = basicSetSubExpression(newSubExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BasePackage.PARANTHESES__SUB_EXPRESSION, newSubExpression, newSubExpression));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case BasePackage.PARANTHESES__SUB_EXPRESSION:
