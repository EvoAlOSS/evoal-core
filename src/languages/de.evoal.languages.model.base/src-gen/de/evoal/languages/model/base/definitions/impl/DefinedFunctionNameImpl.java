 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.definitions.impl.DefinedFunctionNameImpl#getDefinition <em>Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DefinedFunctionNameImpl extends FunctionNameImpl implements DefinedFunctionName {
	...
	protected EClass eStaticClass() {
		return DefinitionsPackage.Literals.DEFINED_FUNCTION_NAME;
	}
		...
		if (definition != null && definition.eIsProxy()) {
			...
			if (definition != oldDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, DefinitionsPackage.DEFINED_FUNCTION_NAME__DEFINITION, oldDefinition, definition));
			}
		}
		return definition;
	}
	...
	public void setDefinition(FunctionDefinition newDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.DEFINED_FUNCTION_NAME__DEFINITION, oldDefinition, definition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DefinitionsPackage.DEFINED_FUNCTION_NAME__DEFINITION:
