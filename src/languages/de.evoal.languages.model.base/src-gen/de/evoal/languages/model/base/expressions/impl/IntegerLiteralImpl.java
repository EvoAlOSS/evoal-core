 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.expressions.impl.IntegerLiteralImpl#getLiteral <em>Literal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntegerLiteralImpl extends NumberLiteralImpl implements IntegerLiteral {
	...
	public void setLiteral(int newLiteral) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExpressionsPackage.INTEGER_LITERAL__LITERAL, oldLiteral, literal));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExpressionsPackage.INTEGER_LITERAL__LITERAL:
				return getLiteral();
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == Literal.class) {
			switch (baseOperationID) {
				case ExpressionsPackage.LITERAL___GET_VALUE: return ExpressionsPackage.INTEGER_LITERAL___GET_VALUE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
		if (baseClass == NumberLiteral.class) {
			switch (baseOperationID) {
				case ExpressionsPackage.NUMBER_LITERAL___GET_VALUE: return ExpressionsPackage.INTEGER_LITERAL___GET_VALUE;
				default: return super.eDerivedOperationID(baseOperationID, baseClass);
			}
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ExpressionsPackage.INTEGER_LITERAL___GET_VALUE:
				return getValue();
		}
