...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Scaled Definition</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.base.definitions.impl.ScaledDefinitionImpl#getScale <em>Scale</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ScaledDefinitionImpl extends MinimalEObjectImpl.Container implements ScaledDefinition {
	 ...
	 * @generated
	 */
	protected ScaledDefinitionImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return DefinitionsPackage.Literals.SCALED_DEFINITION;
	}
	...
	public void setScale(ScaleType newScale) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DefinitionsPackage.SCALED_DEFINITION__SCALE, oldScale, scale));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DefinitionsPackage.SCALED_DEFINITION__SCALE:
				return getScale();
		}
