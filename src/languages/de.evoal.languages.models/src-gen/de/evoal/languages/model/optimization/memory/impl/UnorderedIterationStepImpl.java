...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Unordered Iteration Step</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.optimization.memory.impl.UnorderedIterationStepImpl#getIndividuals <em>Individuals</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnorderedIterationStepImpl extends IterationStepImpl implements UnorderedIterationStep {
	/**
	 ...
	 * @generated
	 */
	protected UnorderedIterationStepImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return MemoryPackage.Literals.UNORDERED_ITERATION_STEP;
	}
	...
	public EList<Individual> getIndividuals() {
		if (individuals == null) {
			individuals = new EObjectContainmentEList<Individual>(Individual.class, this, MemoryPackage.UNORDERED_ITERATION_STEP__INDIVIDUALS);
		}
		return individuals;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case MemoryPackage.UNORDERED_ITERATION_STEP__INDIVIDUALS:
