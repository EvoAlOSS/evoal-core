...
public class PipelineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PipelinePackage.PIPELINE_MODULE: {
				PipelineModule pipelineModule = (PipelineModule)theEObject;
				T result = casePipelineModule(pipelineModule);
	 ...
	 * @generated
	 */
	public T casePipelineModule(PipelineModule object) {
		return null;
	}
