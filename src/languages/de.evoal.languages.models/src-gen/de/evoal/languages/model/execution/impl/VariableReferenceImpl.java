 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.execution.impl.VariableReferenceImpl#getVariable <em>Variable</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VariableReferenceImpl extends ValueReferenceImpl implements VariableReference {
	...
	protected EClass eStaticClass() {
		return ExecutionPackage.Literals.VARIABLE_REFERENCE;
	}
		...
		if (variable != null && variable.eIsProxy()) {
			...
			if (variable != oldVariable) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ExecutionPackage.VARIABLE_REFERENCE__VARIABLE, oldVariable, variable));
			}
		}
		return variable;
	}
	...
	public void setVariable(Variable newVariable) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionPackage.VARIABLE_REFERENCE__VARIABLE, oldVariable, variable));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExecutionPackage.VARIABLE_REFERENCE__VARIABLE:
