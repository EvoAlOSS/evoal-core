 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.pipeline.impl.PipelineStepImpl#getDefinition <em>Definition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PipelineStepImpl extends StepImpl implements PipelineStep {
		...
		if (definition != null && definition.eIsProxy()) {
			...
			if (definition != oldDefinition) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PipelinePackage.PIPELINE_STEP__DEFINITION, oldDefinition, definition));
			}
		}
		return definition;
	}
	...
	public void setDefinition(PipelineDefinition newDefinition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PipelinePackage.PIPELINE_STEP__DEFINITION, oldDefinition, definition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case PipelinePackage.PIPELINE_STEP__DEFINITION:
