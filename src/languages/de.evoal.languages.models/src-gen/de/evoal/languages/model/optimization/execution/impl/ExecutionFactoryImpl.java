...
public class ExecutionFactoryImpl extends EFactoryImpl implements ExecutionFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case ExecutionPackage.TERMINATION_CRITERION: return createTerminationCriterion();
			case ExecutionPackage.SELECTION: return createSelection();
			default:
	 ...
	 */
	@Override
	public TerminationCriterion createTerminationCriterion() {
		TerminationCriterionImpl terminationCriterion = new TerminationCriterionImpl();
