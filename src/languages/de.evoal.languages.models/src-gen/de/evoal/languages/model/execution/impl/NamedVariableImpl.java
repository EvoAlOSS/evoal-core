 ...
 * </p>
 * <ul>
 *   <li>{@link de.evoal.languages.model.execution.impl.NamedVariableImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedVariableImpl extends VariableImpl implements NamedVariable {
	...
	protected EClass eStaticClass() {
		return ExecutionPackage.Literals.NAMED_VARIABLE;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ExecutionPackage.NAMED_VARIABLE__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ExecutionPackage.NAMED_VARIABLE__NAME:
				return getName();
		}
