...
public class PipelineSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PipelinePackage.STATEMENT: {
				Statement statement = (Statement)theEObject;
				T result = caseStatement(statement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PipelinePackage.FOR_STATEMENT: {
			...
			case PipelinePackage.RANGE: {
				Range range = (Range)theEObject;
				T result = caseRange(range);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PipelinePackage.COUNTER_RANGE: {
			...
			case PipelinePackage.LITERAL_RANGE: {
			...
			case PipelinePackage.PIPELINE_DEFINITION_REFERENCE: {
