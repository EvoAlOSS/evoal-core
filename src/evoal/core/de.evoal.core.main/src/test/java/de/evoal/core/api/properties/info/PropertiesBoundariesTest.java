...
class PropertiesBoundariesTest {
    ...
    void testAddAndContains() {
        PropertiesBoundaries.Boundaries boundaries = new PropertiesBoundaries.Boundaries(0, 100);
    ...
    void testGetBoundaries() {
        ...
        PropertiesBoundaries.Boundaries result = propertiesBoundaries.get(property1);
    ...
    void testGetSpecifications() {
        PropertiesBoundaries.Boundaries boundaries1 = new PropertiesBoundaries.Boundaries(0, 100);
        PropertiesBoundaries.Boundaries boundaries2 = new PropertiesBoundaries.Boundaries(10, 200);
