...
@Dependent @Named("de.evoal.core.constraints.UpperBoundary")
@Slf4j
public class UpperBoundaryChecker implements ConstraintCheckerComponent {
    ...
    public ConstraintCheckerComponent init(final Instance config) throws InitializationException {
        ...
        if (isBoundaryIncluded) {
            comparator = BooleanNumberOperations::isGreaterThanOrEqualTo;
        } else {
            comparator = BooleanNumberOperations::isGreaterThan;
        }
