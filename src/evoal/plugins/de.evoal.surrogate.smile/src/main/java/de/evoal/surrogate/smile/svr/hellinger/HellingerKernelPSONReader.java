...
@Named("de.evoal.surrogate.smile.ml.hellinger-svr-reader-pson")
@Dependent
@Slf4j
public class HellingerKernelPSONReader extends AbstractSVRPSONReader {
    @Override
    protected @NonNull KernelBasedSVRFunction toFunction(final @NonNull KernelMachine<double[]> regression,
        ...
        return new HellingerSVRFunction(regression, getInput(), getOutput(), Collections.emptyMap(), gamma, sourceMeans, sourceSDs, targetMeans, targetSDs);
    }
}
