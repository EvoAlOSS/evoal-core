...
@Named("de.evoal.surrogate.smile.ml.thin-plate-spline-svr-reader-pson")
@Dependent
@Slf4j
public class ThinPlateSplineKernelPSONReader extends AbstractSVRPSONReader {
    @Override
    protected @NonNull KernelBasedSVRFunction toFunction(final @NonNull KernelMachine<double[]> regression,
        ...
        return new ThinPlateSplineSVRFunction(regression, getInput(), getOutput(), Collections.emptyMap(), gamma, sourceMeans, sourceSDs, targetMeans, targetSDs);
    }
}
