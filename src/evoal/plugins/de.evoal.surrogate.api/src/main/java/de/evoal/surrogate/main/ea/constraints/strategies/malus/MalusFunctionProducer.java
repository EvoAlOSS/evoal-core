package de.evoal.surrogate.main.ea.constraints.strategies.malus;
...
import de.evoal.surrogate.main.ea.constraints.strategies.malus.internal.MalusForFitnessFunction;
...
public class MalusFunctionProducer {
    ...
    public MalusForFitnessStrategy create(
        ...
        final PropertiesDependencies dependencies = producer.calculatePropertyDependencies(null);
