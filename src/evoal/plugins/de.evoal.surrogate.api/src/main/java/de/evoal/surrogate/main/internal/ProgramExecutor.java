...
@Dependent
@Slf4j
public class ProgramExecutor extends MllSwitch<Object> {
    ...
    @Setter
    private InterpreterState symbolTable = new InterpreterState(null);
    ...
    public Object caseForStatement(final ForStatement loop) {
        ...
        elements.forEach(element -> {
            final InterpreterState scopedTable = new InterpreterState(symbolTable);
    ...
    public void execute(EList<Statement> statements) {
