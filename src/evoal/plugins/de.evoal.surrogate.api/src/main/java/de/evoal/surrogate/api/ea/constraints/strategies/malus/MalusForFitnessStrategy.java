...
import de.evoal.surrogate.api.ea.constraints.strategies.malus.internal.ChainFunction;
import de.evoal.surrogate.api.ea.constraints.strategies.malus.internal.IdentityFunction;
...
public class MalusForFitnessStrategy implements HandlingStrategy {
     ...
     * @param fitnessValues The calculated malus values.
     */
