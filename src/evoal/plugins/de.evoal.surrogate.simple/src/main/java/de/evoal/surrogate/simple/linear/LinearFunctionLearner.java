...
@Dependent
@Named("de.evoal.surrogate.simple.ml.linear-regression-learner")
@Slf4j
public class LinearFunctionLearner extends AbstractModelLearner {
	/**
	 * The input feature.
	 */
	...
	public void add(final TypedEObject features) {
		regression.addData(inputFeature.apply(features), outputFeature.apply(features));
	}
	...
	public @NonNull ModelFunction toFunction() {
		return new LinearFunction(super.inputFeatures, super.outputFeatures, regression.getSlope(), regression.getIntercept());
	}
}
