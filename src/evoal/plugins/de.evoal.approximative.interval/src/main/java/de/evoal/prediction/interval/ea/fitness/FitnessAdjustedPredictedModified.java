package de.evoal.prediction.interval.ea.fitness;
...
@Dependent
@Named("adjusted-modified-fitness")
public class FitnessAdjustedPredictedModified extends OptimisationFunctionDecorator {
