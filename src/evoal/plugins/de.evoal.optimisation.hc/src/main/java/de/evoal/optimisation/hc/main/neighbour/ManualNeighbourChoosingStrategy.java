package de.evoal.optimisation.hc.main.neighbour;
 ...
 */
@Slf4j
@Named("de.evoal.optimisation.hc.optimisation.manual-strategy")
@Dependent
public class ManualNeighbourChoosingStrategy implements NeighbourChoosingStrategy {
    ...
    public Stream<Properties> neighbours(final Properties currentBestCandidate) {
        log.info("current candidate is {}", currentBestCandidate);
